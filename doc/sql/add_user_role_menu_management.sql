-- User, role, and menu management tables.
-- Run this script alone when init.sql fails before system management tables.
...
VALUES
  (1, 'admin', '$2a$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36LNOQ/VKemXEJmzpN3vj52', 'Super Admin', 'SUPER_ADMIN', 1);
