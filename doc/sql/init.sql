...
CREATE TABLE IF NOT EXISTS `channel` (
  ...
  `encrypt_type` VARCHAR(16) NOT NULL DEFAULT 'AES' COMMENT 'Encryption algorithm',
  `cipher_mode` VARCHAR(16) NOT NULL DEFAULT 'ECB' COMMENT 'Cipher mode',
  `padding_mode` VARCHAR(32) NOT NULL DEFAULT 'PKCS5Padding' COMMENT 'Padding mode',
  `iv_value` VARCHAR(64) DEFAULT NULL COMMENT 'IV value for CBC-like modes',
...
CREATE TABLE IF NOT EXISTS `institution` (
  ...
  `cipher_mode` VARCHAR(16) NOT NULL DEFAULT 'CBC' COMMENT 'Request cipher mode',
  `padding_mode` VARCHAR(32) NOT NULL DEFAULT 'PKCS5Padding' COMMENT 'Request padding mode',
  `iv_value` VARCHAR(64) DEFAULT NULL COMMENT 'Request IV value',
  `notify_encrypt_type` VARCHAR(16) NOT NULL DEFAULT 'PLAIN' COMMENT 'Notify encryption mode',
  `notify_cipher_mode` VARCHAR(16) NOT NULL DEFAULT 'CBC' COMMENT 'Notify cipher mode',
  `notify_padding_mode` VARCHAR(32) NOT NULL DEFAULT 'PKCS5Padding' COMMENT 'Notify padding mode',
  `notify_iv_value` VARCHAR(64) DEFAULT NULL COMMENT 'Notify IV value',
...
CREATE TABLE IF NOT EXISTS `apply_order` (
  ...
  `product_name_snapshot` VARCHAR(128) DEFAULT NULL COMMENT 'Winning product name snapshot',
